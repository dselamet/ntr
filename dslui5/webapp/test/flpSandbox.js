		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DSL App Title",
									"targetURL": "#sapbtpdslui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpdslui5-display": {
								"semanticObject": "sapbtpdslui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.dslui5",
									"url": sap.ui.require.toUrl("sap/btp/dslui5")
								}
							}
						}
					}
